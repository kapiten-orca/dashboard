...
<div class="d-flex justify-content-around">
    ...
    <div class="card  mb-3 border border border-warning mx-5" style="max-width: 18rem; max-height: 10rem;">
    ...
    <div class="card  mb-3 border border border-danger mx-5" style="max-width: 18rem; max-height: 10rem;">
